...
public class Calculator {
    ...
    JButton button_pf = new JButton("x²");
    JButton button_fs = new JButton("1/x");
    JButton button_qy = new JButton("%");
    JButton button_kg = new JButton("√x");
    ...
    public Calculator() {
       ...
       pan.add(button_jian); 
        ...
        button_qy.addActionListener(jt_signal);
        button_kg.addActionListener(jt_signal);
        button_pf.addActionListener(jt_signal);
        button_fs.addActionListener(jt_signal);
